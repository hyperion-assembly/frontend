      ...
      <PageHeader className="pb-8">
        ...
        {user ? (
          <>
            ...
            <PageHeaderDescription>I can only show you the door, you&lsquo;re the one that has to walk through it</PageHeaderDescription>
          </>
        ) : (
          <>
            <PageHeaderHeading>Join &nbsp;Hyperion Assembly</PageHeaderHeading>
            <PageHeaderDescription>Connect your Github account</PageHeaderDescription>
          </>
        )}
      </PageHeader>
      {user ? (
        <Link href="/dashboard" className="text-center"><Button variant="default">Go to dashboard 🚪</Button></Link>
      )
        : (
          <Auth
